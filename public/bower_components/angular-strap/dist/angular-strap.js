  ...
  .provider('$typeahead', function() {
    ...
    this.$get = ["$window", "$rootScope", "$tooltip", "$timeout", function($window, $rootScope, $tooltip, $timeout) {
      ...
      function TypeaheadFactory(element, controller, config) {
        ...
        scope.$selectObj = function(index, evt) {
          scope.$$postDigest(function() {
            $typeahead.selectObj(index);
            //console.log(scope.nuevaOrden);
          });
        };
        ...
        $typeahead.selectObj = function(index) {
          var value = scope.$matches[index].value;
          // console.log('$setViewValue', value);
          var c = value.pri + " / " + value.sec
          controller.$setViewValue(c);
          controller.$render();
          scope.$resetMatches();
        ...
        $typeahead.$onKeyDown = function(evt) {
          ...
          if(evt.keyCode === 13 && scope.$matches.length) {
            $typeahead.selectObj(scope.$activeIndex);
          }
