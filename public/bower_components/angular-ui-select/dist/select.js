...
$templateCache.put("select-with-icon/choices.tpl.html","<ul class=\"ui-select-choices ui-select-choices-content dropdown-menu\" role=\"menu\" aria-labelledby=\"dLabel\" ng-show=\"$select.items.length > 0\"><li class=\"ui-select-choices-group\"><div class=\"divider\" ng-show=\"$select.isGrouped && $index > 0\"></div><div ng-show=\"$select.isGrouped\" class=\"ui-select-choices-group-label dropdown-header\" ng-bind-html=\"$group.name\"></div><div class=\"ui-select-choices-row\" ng-class=\"{active: $select.isActive(this), disabled: $select.isDisabled(this)}\"><a href=\"javascript:void(0)\" class=\"ui-select-choices-row-inner\"></a></div></li></ul>");

$templateCache.put("select-with-icon/match.tpl.html","<div class=\"form-group has-icon ui-select-match\" ng-disabled=\"$select.disabled\"><div class=\"form-control input-lg\" tabindex=\"-1\" ;=\"\" ng-click=\"$select.activate()\" required><span ng-show=\"$select.isEmpty()\" class=\"text-muted\">{{$select.placeholder}}</span><span ng-hide=\"$select.isEmpty()\" ng-transclude=\"\">2</span></div><span class=\"fa fa-cab form-control-icon\"></span></div>");


$templateCache.put("select-with-icon/select.tpl.html","<div class=\"ui-select-container ui-select-bootstrap dropdown\" ng-class=\"{open: $select.open}\"><div class=\"ui-select-match\"></div><input type=\"text\" autocomplete=\"off\" tabindex=\"-1\" class=\"form-control ui-select-search\" placeholder=\"{{$select.placeholder}}\" ng-model=\"$select.search\" ng-show=\"$select.searchEnabled && $select.open\"><div class=\"ui-select-choices\"></div></div>");
